...
public class NanosecondBurstinessTest {
   ...
   public void constantRateHighRateNoMillisecondBursts() {
      ...
      // First call at elapsed=0: no past fire times yet, so listener gets 0
      counter.fireTimes = 0;
   ...
   /**
    * Verify that 10ms at 10K TPS fires exactly 100 sessions, not 101.
    * This is a regression test for the off-by-one in FunctionalRateGenerator
    * where the +1 used for scheduling the next proceed() call was also
    * incorrectly included in the listener notification count.
    */
   @Test
